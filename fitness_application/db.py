    ...
    try:
        with conn.cursor() as cur:
            cur.execute(
                ...
                (id, username, question, answer, model_used, response_time, input_tokens,output_tokens, total_tokens, mistralai_cost, interface, relevance,relevance_explanation,eval_input_tokens,eval_output_tokens, eval_total_tokens,eval_cost, timestamp)
